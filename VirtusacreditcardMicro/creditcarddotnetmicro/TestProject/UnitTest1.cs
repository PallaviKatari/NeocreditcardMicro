    ...
    public async Task Backend_Test_Post_CreditCard_By_BranchManager_Returns_Forbidden()
{
   ...
   [Test, Order(11)]
public async Task Backend_Test_Get_All_CreditCards_With_Token_By_CreditCard_Manager_Returns_HttpStatusCode_OK()
{
    string uniqueId = Guid.NewGuid().ToString();
...
public async Task Backend_Test_Get_All_CreditCard_Applications_With_Token_By_Customer_Returns_HttpStatusCode_Forbidden()
{
    ...
    // Generate a unique userName and Email for the test user
    string uniqueUsername = $"creditcardmanager_{uniqueId}";
    string uniqueEmail = $"creditcardmanager{uniqueId}@gmail.com";
...
[Test, Order(19)]
public async Task Backend_Test_Get_All_CreditCard_Disbursements_With_Token_By_Loan_Manager_Returns_HttpStatusCode_OK()
{
    string uniqueId = Guid.NewGuid().ToString();
...
[Test, Order(23)]
public async Task Backend_Test_Get_All_Feedbacks_With_Token_By_CreditCard_Manager_Returns_HttpStatusCode_OK()
{
    string uniqueId = Guid.NewGuid().ToString();
...
[Test, Order(28)]
public async Task Backend_MicroServices_Test_Get_All_Feedbacks_With_Token_By_CreditCard_Manager_Returns_HttpStatusCode_OK()
{
    string uniqueId = Guid.NewGuid().ToString();
...
[Test, Order(32)]
    public async Task Backend_MicroServices_Test_Post_CreditCard_By_CreditCardManager_Returns_HttpStatusCode_OK()
{
    string uniqueId = Guid.NewGuid().ToString();
    ...
    public async Task Backend_MicroServices_Test_Post_CreditCard_By_BranchManager_Returns_Forbidden()
{
   ...
   [Test, Order(35)]
public async Task Backend_MicroServices_Test_Get_All_CreditCards_With_Token_By_CreditCard_Manager_Returns_HttpStatusCode_OK()
{
    string uniqueId = Guid.NewGuid().ToString();
...
[Test, Order(39)]
public async Task Backend_MicroServices_Test_Get_All_CreditCard_Disbursements_With_Token_By_CreditCard_Manager_Returns_HttpStatusCode_OK()
{
    string uniqueId = Guid.NewGuid().ToString();
